...
CREATE TABLE Countries(
	...
	,	CONSTRAINT PK_Countries_CountyID PRIMARY KEY(CountyID) 	
...
CREATE TABLE States(
	...
	,	CONSTRAINT FK_Countries_States_CountyID FOREIGN KEY(CountyID) REFERENCES Countries(CountyID) ON DELETE CASCADE ON UPDATE CASCADE
)
...
CREATE TABLE UserLanguages(
	...
	,	CONSTRAINT FK_Users_UserLanguages_UserId FOREIGN KEY(UserID) REFERENCES Users(UserID) ON DELETE CASCADE ON UPDATE CASCADE
	,	CONSTRAINT FK_Languages_UserLanguages_LanguageID FOREIGN KEY(LanguageID) REFERENCES Languages(LanguageID) ON DELETE CASCADE ON UPDATE CASCADE
)
...
CREATE TABLE Albums(
	...
	,	CONSTRAINT FK_Albums_States_CountyID FOREIGN KEY(CountyID) REFERENCES Countries(CountyID) ON DELETE SET NULL ON UPDATE CASCADE
